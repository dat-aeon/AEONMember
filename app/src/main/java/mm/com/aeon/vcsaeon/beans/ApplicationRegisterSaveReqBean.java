...
public class ApplicationRegisterSaveReqBean {
    ...
    public Integer getPermanentAddressTownship() {
        if (permanentAddressTownship == null) {
            permanentAddressTownship = 0;
        }
    ...
    public boolean isBeanValid() {
        if (getDaApplicationTypeId() == ZERO) {
            return false;
        }
        if (getChannelType() == ZERO) {
            return false;
        }
        if (getCustomerId() == ZERO) {
            return false;
        }
        return true;
    }
    ...
    public void setDaInterestInfoId(Double daInterestInfoId) {
    ...
    public void setDaCompulsoryInfoId(Double daCompulsoryInfoId) {
