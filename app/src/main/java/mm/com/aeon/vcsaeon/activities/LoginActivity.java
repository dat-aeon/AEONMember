...
public class LoginActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        icLoginClose = findViewById(R.id.close_login);
        lblLoginTitle = findViewById(R.id.lblLoginTitle);
        ...
        icLoginClose.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void onClick(View v) {
                ...
                switch (biometricSensorStatus) {
                    case BIOMETRIC_OK:
                        ...
                        break;
                    case NOT_ENROLLED:
                        UiUtils.showWarningDialog(LoginActivity.this, getBiometricNotEnrolledMsg());
                        break;
                    case DOES_NOT_SUPPORT:
                        UiUtils.showWarningDialog(LoginActivity.this, getBiometricNotSupportMsg());
                        break;
                }
            }
        });
                                        ...
                                        if (response.isSuccessful()) {
                                            ...
                                            if (loginBaseResponse.getStatus().equals(SUCCESS)) {
                                                ...
                                                if (loginBaseResponse.getMessageCode().equals(ACCOUNT_LOCKED_STATUS)) {
                                                    ...
                                                    final Dialog mDialog = new Dialog(LoginActivity.this);
                                                    mDialog.setContentView(R.layout.biometric_not_match_dialog);
                                                    mDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                                                    mDialog.getWindow().setLayout(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                                                    mDialog.setCancelable(false);
                                                    TextView textMessage = mDialog.findViewById(R.id.text_message);
                                                    textMessage.setText(getInvalidBiometricMsg());

                                                    Button btnCancel = mDialog.findViewById(R.id.btn_skip);
                                                    ...
                                                    Button btnOk = mDialog.findViewById(R.id.btn_upgrade);
                                                    btnOk.setOnClickListener(new View.OnClickListener() {
                                                        @Override
                                                        public void onClick(View v) {
                                                            //(2) | get response
    ...
    public void changeLabel(String language) {
        ...
        lblLoginTitle.setText(CommonUtils.getLocaleString(new Locale(language), R.string.login_login_btn, getApplicationContext()));
