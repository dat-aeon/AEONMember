...
public class NavEventsAndNewsFragment extends BaseFragment implements LanguageChangeListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.events_and_news_fragment, container, false);
        ...
        viewPager.setCurrentItem(EventsNewsTabPosition);
    ...
    public void changeLanguageTitle(String lang) {
        ...
        if (PreferencesManager.getMainNavFlag(getActivity())) {
            ...
            replaceFragment(new NavEventsAndNewsFragment(), R.id.content_main_drawer);
        }
    }
