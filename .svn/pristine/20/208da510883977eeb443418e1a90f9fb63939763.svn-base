...
public class SecondLevelAdapter extends BaseExpandableListAdapter
{
                             ...
                             boolean isLastChild, View convertView, ViewGroup parent)
    {
        ...
        txtListChild.setTypeface(ResourcesCompat.getFont(mContext, R.font.pyidaungsu_bold), Typeface.BOLD);
                             ...
                             View convertView, ViewGroup parent)
    {
        ...
        lblListHeader.setPadding(10,0,100,0);
        lblListHeader.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
        lblListHeader.setTextColor(mContext.getColor(R.color.colorPrimary));
        return convertView;
    }
    @Override
